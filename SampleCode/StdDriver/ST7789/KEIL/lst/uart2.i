...
uint8_t g_uart_rx_buffer[256];
uint8_t g_uart_buffer;
volatile uint16_t g_uart_point;
volatile uint8_t g_uart_tx_done;
...
uint8_t g_uart2_buffer;
volatile uint16_t g_uart2_point;
volatile uint8_t g_uart2_tx_done;
# 68 "../uart2.c"
uint8_t uart_init(uint32_t baud)
{
# 84 "../uart2.c"
     UART_Open(((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x30000UL)), baud);
# 93 "../uart2.c"
    return 0;
}
# 103 "../uart2.c"
uint8_t uart_deinit(void)
{
    ...
    UART_Close(((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x30000UL)));
    return 0;
}
# 123 "../uart2.c"
uint8_t uart_write(uint8_t *buf, uint16_t len)
{
 ...
 UART_Write(((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x30000UL)), buf, len);
...
uint8_t uart2_write(uint8_t *buf, uint16_t len)
{
 ...
 UART_Write(((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x32000UL)), buf, len);
