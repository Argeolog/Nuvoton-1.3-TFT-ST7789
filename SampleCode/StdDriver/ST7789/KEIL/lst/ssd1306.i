...
# 2 "../ssd1306/ssd1306.c" 2
# 1 "../ssd1306\\ssd1306.h" 1
# 11 "../ssd1306\\ssd1306.h"
...
# 12 "../ssd1306\\ssd1306.h" 2



# 1 "../ssd1306\\ssd1306_conf.h" 1
...
# 16 "../ssd1306\\ssd1306.h" 2


# 1 "../ssd1306\\ssd1306_fonts.h" 1
...
# 19 "../ssd1306\\ssd1306.h" 2
# 34 "../ssd1306\\ssd1306.h"
...
# 6 "../ssd1306/ssd1306.c" 2
# 1 "../../OLED\\HAL_TICK_CONTROL.h" 1
extern uint32_t HAL_GetTick(void);
extern void HAL_Delay( uint32_t Delay);
extern void HAL_InitTick(uint32_t TickPriority);
# 7 "../ssd1306/ssd1306.c" 2
void ssd1306_Reset(void) {
...
void ssd1306_WriteCommand(uint8_t byte) {
 I2C_WriteByteOneReg(((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL)),0x3c//(0x3C << 1),0x00,byte);
}

// Send data
void ssd1306_WriteData(uint8_t* buffer, size_t buff_size) {
 I2C_WriteMultiBytesOneReg(((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL)),0x3c//(0x3C << 1),0x40,buffer,buff_size);
}
...
void ssd1306_DrawArc(uint8_t x, uint8_t y, uint8_t radius, uint16_t start_angle, uint16_t sweep, SSD1306_COLOR color) {
    ...
    count = (ssd1306_NormalizeTo0_360(start_angle) * 36) / 360;
    approx_segments = (loc_sweep * 36) / 360;
