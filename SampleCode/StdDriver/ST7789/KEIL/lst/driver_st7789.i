...
# 38 "../driver_st7789.c" 2
# 1 "..\\driver_st7789_font.h" 1
# 48 "..\\driver_st7789_font.h"
...
# 39 "../driver_st7789.c" 2
# 136 "../driver_st7789.c"
static uint8_t a_st7789_write_byte(st7789_handle_t *handle, uint8_t data, uint8_t cmd)
{
    uint8_t res;

    res = handle->cmd_data_gpio_write(cmd);
    if (res != 0)
    {
        return 1;
    }
    res = handle->spi_write_cmd(&data, 1);
    if (res != 0)
    {
        return 1;
    }
...
static uint8_t a_st7789_write_bytes(st7789_handle_t *handle, uint8_t *data, uint16_t len, uint8_t cmd)
{
    ...
    res = handle->spi_write_cmd(data, len);
    if (res != 0)
    {
        return 1;
    }
...
uint8_t st7789_nop(st7789_handle_t *handle)
{
    ...
    if (a_st7789_write_byte(handle, 0x00, 0) != 0)
    {
...
uint8_t st7789_software_reset(st7789_handle_t *handle)
{
    ...
    if (a_st7789_write_byte(handle, 0x01, 0) != 0)
    {
...
uint8_t st7789_sleep_in(st7789_handle_t *handle)
{
    ...
    if (a_st7789_write_byte(handle, 0x10, 0) != 0)
    {
...
uint8_t st7789_sleep_out(st7789_handle_t *handle)
{
    ...
    if (a_st7789_write_byte(handle, 0x11, 0) != 0)
    {
...
uint8_t st7789_partial_display_mode_on(st7789_handle_t *handle)
{
    ...
    if (a_st7789_write_byte(handle, 0x12, 0) != 0)
    {
...
uint8_t st7789_normal_display_mode_on(st7789_handle_t *handle)
{
    ...
    if (a_st7789_write_byte(handle, 0x13, 0) != 0)
    {
...
uint8_t st7789_display_inversion_off(st7789_handle_t *handle)
{
    ...
    if (a_st7789_write_byte(handle, 0x20, 0) != 0)
    {
...
uint8_t st7789_display_inversion_on(st7789_handle_t *handle)
{
    ...
    if (a_st7789_write_byte(handle, 0x21, 0) != 0)
    {
...
uint8_t st7789_set_gamma(st7789_handle_t *handle, uint8_t gamma)
{
    ...
    if (a_st7789_write_byte(handle, 0x26, 0) != 0)
    {


        return 1;
    }
    if (a_st7789_write_byte(handle, gamma & 0x0F, 1) != 0)
    {
...
uint8_t st7789_display_off(st7789_handle_t *handle)
{
    ...
    if (a_st7789_write_byte(handle, 0x28, 0) != 0)
    {
...
uint8_t st7789_display_on(st7789_handle_t *handle)
{
    ...
    if (a_st7789_write_byte(handle, 0x29, 0) != 0)
    {
...
uint8_t st7789_set_column_address(st7789_handle_t *handle, uint16_t start_address, uint16_t end_address)
{
    ...
    if ((start_address > 319) || (end_address > 319))
    {
    ...
    if (a_st7789_write_byte(handle, 0x2A, 0) != 0)
    {


        return 1;
    }
    buf[0] = (start_address >> 8) & 0xFF;
    buf[1] = (start_address >> 0) & 0xFF;
    buf[2] = (end_address >> 8) & 0xFF;
    buf[3] = (end_address >> 0) & 0xFF;
    if (a_st7789_write_bytes(handle, buf, 4, 1) != 0)
    {
...
uint8_t st7789_set_row_address(st7789_handle_t *handle, uint16_t start_address, uint16_t end_address)
{
    ...
    if (a_st7789_write_byte(handle, 0x2B, 0) != 0)
    {
...
uint8_t st7789_memory_write(st7789_handle_t *handle, uint8_t *data, uint16_t len)
{
    ...
    if (a_st7789_write_byte(handle, 0x2C, 0) != 0)
    {


        return 1;
    }
    if (a_st7789_write_bytes(handle, data, len, 1) != 0)
    {
...
uint8_t st7789_set_partial_areas(st7789_handle_t *handle, uint16_t start_row, uint16_t end_row)
{
    ...
    if (a_st7789_write_byte(handle, 0x30, 0) != 0)
    {


        return 1;
    }
    buf[0] = (start_row >> 8) & 0xFF;
    buf[1] = (start_row >> 0) & 0xFF;
    buf[2] = (end_row >> 8) & 0xFF;
    buf[3] = (end_row >> 0) & 0xFF;
    if (a_st7789_write_bytes(handle, buf, 4, 1) != 0)
    {
                                      ...
                                      uint16_t scrolling_area, uint16_t bottom_fixed_area)
{
    ...
    if (a_st7789_write_byte(handle, 0x33, 0) != 0)
    {


        return 1;
    }
    buf[0] = (top_fixed_area >> 8) & 0xFF;
    buf[1] = (top_fixed_area >> 0) & 0xFF;
    buf[2] = (scrolling_area >> 8) & 0xFF;
    buf[3] = (scrolling_area >> 0) & 0xFF;
    buf[4] = (bottom_fixed_area >> 8) & 0xFF;
    buf[5] = (bottom_fixed_area >> 0) & 0xFF;
    if (a_st7789_write_bytes(handle, buf, 6, 1) != 0)
    {
...
uint8_t st7789_tearing_effect_line_off(st7789_handle_t *handle)
{
    ...
    if (a_st7789_write_byte(handle, 0x34, 0) != 0)
    {
...
uint8_t st7789_tearing_effect_line_on(st7789_handle_t *handle, st7789_tearing_effect_t effect)
{
    ...
    if (a_st7789_write_byte(handle, 0x35, 0) != 0)
    {


        return 1;
    }
    if (a_st7789_write_byte(handle, effect, 1) != 0)
    {
...
uint8_t st7789_set_memory_data_access_control(st7789_handle_t *handle, uint8_t order)
{
    ...
    if (a_st7789_write_byte(handle, 0x36, 0) != 0)
    {


        return 1;
    }
    if (a_st7789_write_byte(handle, order, 1) != 0)
    {
...
uint8_t st7789_set_vertical_scroll_start_address(st7789_handle_t *handle, uint16_t start_address)
{
    ...
    if (a_st7789_write_byte(handle, 0x37, 0) != 0)
    {
    ...
    buf[0] = (start_address >> 8) & 0xFF;
    buf[1] = (start_address >> 0) & 0xFF;
    if (a_st7789_write_bytes(handle, buf, 2, 1) != 0)
    {
...
uint8_t st7789_idle_mode_off(st7789_handle_t *handle)
{
    ...
    if (a_st7789_write_byte(handle, 0x38, 0) != 0)
    {
...
uint8_t st7789_idle_mode_on(st7789_handle_t *handle)
{
    ...
    if (a_st7789_write_byte(handle, 0x39, 0) != 0)
    {
                                          ...
                                          st7789_control_interface_color_format_t control)
{
    ...
    if (a_st7789_write_byte(handle, 0x3A, 0) != 0)
    {
    ...
    data = (rgb << 4) | (control << 0);
    if (a_st7789_write_byte(handle, data, 1) != 0)
    {
...
uint8_t st7789_memory_continue_write(st7789_handle_t *handle, uint8_t *data, uint16_t len)
{
    ...
    if (a_st7789_write_byte(handle, 0x3C, 0) != 0)
    {
...
uint8_t st7789_set_tear_scanline(st7789_handle_t *handle, uint16_t l)
{
    ...
    if (a_st7789_write_byte(handle, 0x44, 0) != 0)
    {
...
uint8_t st7789_set_display_brightness(st7789_handle_t *handle, uint8_t brightness)
{
    ...
    if (a_st7789_write_byte(handle, 0x51, 0) != 0)
    {
    ...
    if (a_st7789_write_byte(handle, brightness, 1) != 0)
    {
                                   ...
                                   st7789_bool_t display_dimming, st7789_bool_t backlight_control)
{
    ...
    if (a_st7789_write_byte(handle, 0x53, 0) != 0)
    {
                                                            ...
                                                            st7789_color_enhancement_mode_t mode, st7789_color_enhancement_level_t level)
{
    ...
    if (a_st7789_write_byte(handle, 0x55, 0) != 0)
    {
    ...
    data = (color_enhancement << 7) | (level << 4) | (mode << 0);
    if (a_st7789_write_byte(handle, data, 1) != 0)
    {
...
uint8_t st7789_set_cabc_minimum_brightness(st7789_handle_t *handle, uint8_t brightness)
{
    ...
    if (a_st7789_write_byte(handle, 0x5E, 0) != 0)
    {
                               ...
                               st7789_pixel_type_t pixel_type)
{
    ...
    if (a_st7789_write_byte(handle, 0xB0, 0) != 0)
    {


        return 1;
    }
    buf[0] = (ram_mode << 4) | (display_mode << 0);
    buf[1] = (frame_type << 4) | (data_mode << 3) |
             (bus_width << 2) | (pixel_type << 0);
    if (a_st7789_write_bytes(handle, buf, 2, 1) != 0)
    {
                                         ...
                                         uint8_t hbp)
{
    ...
    if (a_st7789_write_byte(handle, 0xB1, 0) != 0)
    {
    ...
    buf[0] = (rgb_mode << 7) | (rgb_if_mode << 5) |
             (vspl << 3) | (hspl << 2) | (dpl << 1) | (epl << 0);
    buf[1] = vbp & 0x7F;
    buf[2] = hbp & 0x1F;
    if (a_st7789_write_bytes(handle, buf, 3, 1) != 0)
    {
                         ...
                         uint8_t front_porch_partial)
{
    ...
    if (back_porch_normal > 0x7F)
    {


        return 4;
    }
    if (front_porch_normal > 0x7F)
    {


        return 5;
    }
    if (back_porch_idle > 0xF)
    {


        return 6;
    }
    if (front_porch_idle > 0xF)
    {


        return 7;
    }
    if (back_porch_partial > 0xF)
    {


        return 8;
    }
    if (front_porch_partial > 0xF)
    {
    ...
    if (a_st7789_write_byte(handle, 0xB2, 0) != 0)
    {


        return 1;
    }
    buf[0] = back_porch_normal;
    buf[1] = front_porch_normal;
    buf[2] = separate_porch_enable;
    buf[3] = (back_porch_idle & 0xF) << 4 | (front_porch_idle & 0xF);
    buf[4] = (back_porch_partial & 0xF) << 4 | (front_porch_partial & 0xF);
    if (a_st7789_write_bytes(handle, buf, 5, 1) != 0)
    {
                                      ...
                                      uint8_t partial_frame_rate)
{
    ...
    if (idle_frame_rate > 0x1F)
    {


        return 4;
    }
    if (partial_frame_rate > 0x1F)
    {
    ...
    if (a_st7789_write_byte(handle, 0xB3, 0) != 0)
    {


        return 1;
    }
    buf[0] = (separate_fr_control << 4) | (div_control << 0);
    buf[1] = (idle_mode << 5) | ((idle_frame_rate & 0x1F) << 0);
    buf[2] = (partial_mode << 5) | ((partial_frame_rate & 0x1F) << 0);
    if (a_st7789_write_bytes(handle, buf, 3, 1) != 0)
    {
                                        ...
                                        st7789_non_display_frame_frequency_t frequency)
{
    ...
    if (a_st7789_write_byte(handle, 0xB5, 0) != 0)
    {


        return 1;
    }
    reg = (level << 7) | (mode << 4) | (frequency << 0);
    if (a_st7789_write_byte(handle, reg, 1) != 0)
    {
...
uint8_t st7789_set_gate_control(st7789_handle_t *handle, st7789_vghs_t vghs, st7789_vgls_t vgls)
{
    ...
    if (a_st7789_write_byte(handle, 0xB7, 0) != 0)
    {
                                             ...
                                             uint8_t gate_off_timing_adjustment)
{
    ...
    if (gate_on_timing_adjustment > 0x3F)
    {


        return 4;
    }
    if (gate_off_timing_adjustment_rgb > 0xF)
    {


        return 5;
    }
    if (gate_off_timing_adjustment > 0xF)
    {
    ...
    if (a_st7789_write_byte(handle, 0xB8, 0) != 0)
    {
    ...
    buf[0] = 0x2A;
    buf[1] = 0x2B;
    buf[2] = gate_on_timing_adjustment & 0x3F;
    buf[3] = ((gate_off_timing_adjustment_rgb & 0xF) << 4) |
             ((gate_off_timing_adjustment & 0xF) << 0);
    if (a_st7789_write_bytes(handle, buf, 4, 1) != 0)
    {
...
uint8_t st7789_set_digital_gamma(st7789_handle_t *handle, st7789_bool_t enable)
{
    ...
    if (a_st7789_write_byte(handle, 0xBA, 0) != 0)
    {
...
uint8_t st7789_set_vcoms(st7789_handle_t *handle, uint8_t vcoms)
{
    ...
    if (a_st7789_write_byte(handle, 0xBB, 0) != 0)
    {
...
uint8_t st7789_vcom_convert_to_register(st7789_handle_t *handle, float v, uint8_t *reg)
{
    ...
    *reg = (uint8_t)((v - 0.1f) / 0.025f);

    return 0;
}
# 1884 "../driver_st7789.c"
uint8_t st7789_vcom_convert_to_data(st7789_handle_t *handle, uint8_t reg, float *v)
{
    if (handle == 0)
    {
    ...
    *v = (uint8_t)((float)(reg) * 0.025f + 0.1f);

    return 0;
}
# 1917 "../driver_st7789.c"
uint8_t st7789_set_lcm_control(st7789_handle_t *handle,
                               st7789_bool_t xmy,
                               st7789_bool_t xbgr,
                               st7789_bool_t xinv,
                               ...
                               st7789_bool_t xgs)
{
    ...
    if (a_st7789_write_byte(handle, 0xC0, 0) != 0)
    {
...
uint8_t st7789_set_id_code_setting(st7789_handle_t *handle, uint8_t id[3])
{
    ...
    if (a_st7789_write_byte(handle, 0xC1, 0) != 0)
    {


        return 1;
    }
    if (a_st7789_write_bytes(handle, id, 3, 1) != 0)
    {
...
uint8_t st7789_set_vdv_vrh_from(st7789_handle_t *handle, st7789_vdv_vrh_from_t from)
{
    ...
    if (a_st7789_write_byte(handle, 0xC2, 0) != 0)
    {
...
uint8_t st7789_set_vrhs(st7789_handle_t *handle, uint8_t vrhs)
{
    ...
    if (a_st7789_write_byte(handle, 0xC3, 0) != 0)
    {
...
uint8_t st7789_vrhs_convert_to_register(st7789_handle_t *handle, float v, uint8_t *reg)
{
    ...
    *reg = (uint8_t)((v - 3.55f) / 0.05f);

    return 0;
}
# 2121 "../driver_st7789.c"
uint8_t st7789_vrhs_convert_to_data(st7789_handle_t *handle, uint8_t reg, float *v)
{
    if (handle == 0)
    {
    ...
    *v = (uint8_t)((float)(reg) * 0.05f + 3.55f);

    return 0;
}
# 2149 "../driver_st7789.c"
uint8_t st7789_set_vdv(st7789_handle_t *handle, uint8_t vdv)
{
    uint8_t reg;
    ...
    if (a_st7789_write_byte(handle, 0xC4, 0) != 0)
    {
...
uint8_t st7789_vdv_convert_to_register(st7789_handle_t *handle, float v, uint8_t *reg)
{
    ...
    *reg = (uint8_t)((v + 0.8f) / 0.025f);

    return 0;
}
# 2223 "../driver_st7789.c"
uint8_t st7789_vdv_convert_to_data(st7789_handle_t *handle, uint8_t reg, float *v)
{
    if (handle == 0)
    {
    ...
    *v = (uint8_t)((float)(reg) * 0.025f - 0.8f);

    return 0;
}
# 2251 "../driver_st7789.c"
uint8_t st7789_set_vcoms_offset(st7789_handle_t *handle, uint8_t offset)
{
    uint8_t reg;
    ...
    if (a_st7789_write_byte(handle, 0xC5, 0) != 0)
    {
...
uint8_t st7789_set_frame_rate(st7789_handle_t *handle, st7789_inversion_selection_t selection, st7789_frame_rate_t rate)
{
    ...
    if (a_st7789_write_byte(handle, 0xC6, 0) != 0)
    {


        return 1;
    }
    reg = (selection << 5) | (rate << 0);
    if (a_st7789_write_byte(handle, reg, 1) != 0)
    {
                                ...
                                st7789_bool_t led_pwm_polarity)
{
    ...
    if (a_st7789_write_byte(handle, 0xC7, 0) != 0)
    {
    ...
    reg = (led_on << 3) | (led_pwm_init << 2) |
          (led_pwm_fix << 1) | (led_pwm_polarity << 0);
    if (a_st7789_write_byte(handle, reg, 1) != 0)
    {
...
uint8_t st7789_set_pwm_frequency(st7789_handle_t *handle, st7789_pwm_frequency_t frequency)
{
    ...
    if (a_st7789_write_byte(handle, 0xCC, 0) != 0)
    {
...
uint8_t st7789_set_power_control_1(st7789_handle_t *handle, st7789_avdd_t avdd, st7789_avcl_t avcl, st7789_vds_t vds)
{
    ...
    if (a_st7789_write_byte(handle, 0xD0, 0) != 0)
    {
...
uint8_t st7789_enable_vap_van_signal_output(st7789_handle_t *handle)
{
    ...
    if (a_st7789_write_byte(handle, 0xD2, 0) != 0)
    {
...
uint8_t st7789_set_command_2_enable(st7789_handle_t *handle, st7789_bool_t enable)
{
    ...
    if (a_st7789_write_byte(handle, 0xDF, 0) != 0)
    {
...
uint8_t st7789_set_positive_voltage_gamma_control(st7789_handle_t *handle, uint8_t param[14])
{
    ...
    if (a_st7789_write_byte(handle, 0xE0, 0) != 0)
    {


        return 1;
    }
    if (a_st7789_write_bytes(handle, param, 14, 1) != 0)
    {
...
uint8_t st7789_set_negative_voltage_gamma_control(st7789_handle_t *handle, uint8_t param[14])
{
    ...
    if (a_st7789_write_byte(handle, 0xE1, 0) != 0)
    {
...
uint8_t st7789_set_digital_gamma_look_up_table_red(st7789_handle_t *handle, uint8_t param[64])
{
    ...
    if (a_st7789_write_byte(handle, 0xE2, 0) != 0)
    {


        return 1;
    }
    if (a_st7789_write_bytes(handle, param, 64, 1) != 0)
    {
...
uint8_t st7789_set_digital_gamma_look_up_table_blue(st7789_handle_t *handle, uint8_t param[64])
{
    ...
    if (a_st7789_write_byte(handle, 0xE3, 0) != 0)
    {
                        ...
                        st7789_gate_scan_direction_t direction)
{
    ...
    if (gate_line_number > 0x3F)
    {


        return 4;
    }
    if (first_scan_line_number > 0x3F)
    {
    ...
    if (a_st7789_write_byte(handle, 0xE4, 0) != 0)
    {


        return 1;
    }
    buf[0] = gate_line_number;
    buf[1] = first_scan_line_number;
    buf[2] = 0x10 | (mode << 2) | (direction << 0);
    if (a_st7789_write_bytes(handle, buf, 3, 1) != 0)
    {
...
uint8_t st7789_set_spi2_enable(st7789_handle_t *handle, st7789_bool_t date_lane, st7789_bool_t command_table_2)
{
    ...
    if (a_st7789_write_byte(handle, 0xE7, 0) != 0)
    {


        return 1;
    }
    reg = (date_lane << 4) | (command_table_2 << 0);
    if (a_st7789_write_byte(handle, reg, 1) != 0)
    {
...
uint8_t st7789_set_power_control_2(st7789_handle_t *handle, st7789_sbclk_div_t sbclk, st7789_stp14ck_div_t stp14ck)
{
    ...
    if (a_st7789_write_byte(handle, 0xE8, 0) != 0)
    {


        return 1;
    }
    reg = (sbclk << 4) | (stp14ck << 0);
    if (a_st7789_write_byte(handle, reg, 1) != 0)
    {
                                         ...
                                         uint8_t gate_equalize_time)
{
    ...
    if (source_equalize_time > 0x1F)
    {


        return 4;
    }
    if (source_pre_drive_time > 0x1F)
    {


        return 5;
    }
    if (gate_equalize_time > 0xF)
    {
    ...
    if (a_st7789_write_byte(handle, 0xE9, 0) != 0)
    {


        return 1;
    }
    buf[0] = source_equalize_time;
    buf[1] = source_pre_drive_time;
    buf[2] = gate_equalize_time;
    if (a_st7789_write_bytes(handle, buf, 3, 1) != 0)
    {
...
uint8_t st7789_set_program_mode_control(st7789_handle_t *handle)
{
    ...
    if (a_st7789_write_byte(handle, 0xEC, 0) != 0)
    {
...
uint8_t st7789_set_program_mode_enable(st7789_handle_t *handle, st7789_bool_t enable)
{
    ...
    if (a_st7789_write_byte(handle, 0xFA, 0) != 0)
    {
...
uint8_t st7789_set_nvm_setting(st7789_handle_t *handle, uint8_t addr, uint8_t data)
{
    ...
    if (a_st7789_write_byte(handle, 0xFC, 0) != 0)
    {
...
uint8_t st7789_set_program_action(st7789_handle_t *handle)
{
    ...
    if (a_st7789_write_byte(handle, 0xFE, 0) != 0)
    {
...
uint8_t st7789_init(st7789_handle_t *handle)
{
    ...
    if (handle->spi_write_cmd == 0)
    {


        return 3;
    }
    if (handle->cmd_data_gpio_init == 0)
    {


        return 3;
    }
    if (handle->cmd_data_gpio_deinit == 0)
    {


        return 3;
    }
    if (handle->cmd_data_gpio_write == 0)
    {
    ...
    if (handle->reset_gpio_init() != 0)
    {
        ...
        (void)handle->cmd_data_gpio_deinit();
...
uint8_t st7789_clear(st7789_handle_t *handle)
{
    ...
    buf[0] = (0x00 >> 8) & 0xFF;
    buf[1] = (0x00 >> 0) & 0xFF;
    buf[2] = ((handle->column - 1) >> 8) & 0xFF;
    buf[3] = ((handle->column - 1) >> 0) & 0xFF;
    if (a_st7789_write_bytes(handle, buf, 4, 1) != 0)
    {
    ...
    buf[0] = (0x00 >> 8) & 0xFF;
    buf[1] = (0x00 >> 0) & 0xFF;
    buf[2] = ((handle->row - 1) >> 8) & 0xFF;
    buf[3] = ((handle->row - 1) >> 0) & 0xFF;
    if (a_st7789_write_bytes(handle, buf, 4, 1) != 0)
    {
    ...
    if ((handle->format & 0x03) == 0x03)
    {
        memset(handle->buf, 0x00, sizeof(uint8_t) * (4096));
        ...
        if (n != 0)
        {
            if (a_st7789_write_bytes(handle, handle->buf, n, 1) != 0)
            {
    ...
    else if ((handle->format & 0x05) == 0x05)
    {
        memset(handle->buf, 0x00, sizeof(uint8_t) * (4096));
        m = (uint32_t)(handle->row) * handle->column * 2 / (4096);
        n = (uint32_t)(handle->row) * handle->column * 2 % (4096);
        for (i = 0; i < m; i++)
        {
            if (a_st7789_write_bytes(handle, handle->buf,
                (4096), 1) != 0)
    ...
    else if ((handle->format & 0x06) == 0x06)
    {
        memset(handle->buf, 0x00, sizeof(uint8_t) * (4096));
        m = (uint32_t)(handle->row) * handle->column * 3 / (4096);
        n = (uint32_t)(handle->row) * handle->column * 3 % (4096);
        for (i = 0; i < m; i++)
        {
            if (a_st7789_write_bytes(handle, handle->buf,
                (4096), 1) != 0)
...
uint8_t st7789_fill_rect(st7789_handle_t *handle, uint16_t left, uint16_t top, uint16_t right, uint16_t bottom, uint32_t color)
{
    ...
    if (left > (handle->column - 1))
    {


        return 4;
    }
    if (right > (handle->column - 1))
    {
    ...
    else if ((handle->format & 0x05) == 0x05)
    {
        for (i = 0; i < (4096); i += 2)
        {
            handle->buf[i] = (color >> 8) & 0xFF;
            handle->buf[i + 1] = (color >> 0) & 0xFF;
        }
    ...
    else if ((handle->format & 0x06) == 0x06)
    {
        for (i = 0; i < (4096); i += 3)
        {
            handle->buf[i] = ((color >> 12) & 0x3F) << 2;
            handle->buf[i + 1] = ((color >> 6) & 0x3F) << 2;
            handle->buf[i + 2] = ((color >> 0) & 0x3F) << 2;
        }
...
uint8_t st7789_draw_picture_16bits(st7789_handle_t *handle, uint16_t left, uint16_t top, uint16_t right, uint16_t bottom, uint16_t *image)
{
    ...
    if ((handle->format & 0x05) == 0x05)
    {
        ...
        for (i = 0; i < m; i++)
        {
            ...
            {
                color = image[(point % c) * r + (point / c)];
                handle->buf[j] = (color >> 8) & 0xFF;
                handle->buf[j + 1] = (color >> 0) & 0xFF;
                point++;
            }
            if (a_st7789_write_bytes(handle, handle->buf,
                (4096), 1) != 0)
...
uint8_t st7789_draw_picture_18bits(st7789_handle_t *handle, uint16_t left, uint16_t top, uint16_t right, uint16_t bottom, uint32_t *image)
{
    ...
    if ((handle->format & 0x06) == 0x06)
    {
        ...
        for (i = 0; i < m; i++)
        {
            ...
            {
                color = image[(point % c) * r + (point / c)];
                handle->buf[j] = ((color >> 12) & 0x3F) << 2;
                handle->buf[j + 1] = ((color >> 6) & 0x3F) << 2;
                handle->buf[j + 2] = ((color >> 0) & 0x3F) << 2;
                point++;
            }
            if (a_st7789_write_bytes(handle, handle->buf,
                (4096), 1) != 0)
...
static uint8_t a_st7789_draw_point(st7789_handle_t *handle, uint16_t x, uint16_t y, uint32_t color)
{
    ...
    {
        handle->buf[0] = (color >> 8) & 0xFF;
        handle->buf[1] = (color >> 0) & 0xFF;
        if (a_st7789_write_bytes(handle, handle->buf,
            2, 1) != 0)
        {
    ...
    {
        handle->buf[0] = ((color >> 12) & 0x3F) << 2;
        handle->buf[1] = ((color >> 6) & 0x3F) << 2;
        handle->buf[2] = ((color >> 0) & 0x3F) << 2;
        if (a_st7789_write_bytes(handle, handle->buf,
            3, 1) != 0)
        {
...
static uint8_t a_st7789_show_char(st7789_handle_t *handle, uint16_t x, uint16_t y, uint8_t chr, uint8_t size, uint32_t color)
{
    ...
    for (t = 0; t < csize; t++)
    {
        if (size == 12)
        {
            temp = gsc_st7789_ascii_1206[chr][t];
        }
        else if (size == 16)
        {
            temp = gsc_st7789_ascii_1608[chr][t];
        }
        else if(size == 24)
        {
            temp = gsc_st7789_ascii_2412[chr][t];
        }
        else
        {
            return 1;
        ...
        for (t1 = 0; t1 < 8; t1++)
        {
            if ((temp & 0x80) != 0)
            {
                if (a_st7789_draw_point(handle, x, y, color) != 0)
                {
                    return 1;
                }
            }
...
uint8_t st7789_write_string(st7789_handle_t *handle, uint16_t x, uint16_t y, char *str, uint16_t len, uint32_t color, st7789_font_t font)
{
    ...
    if((x >= handle->column) || (y >= handle->row))
    {
    ...
    while ((len != 0) && (*str <= '~') && (*str >= ' '))
    {
        if (x >= (handle->column - (font / 2)))
        {
            x = 0;
            y += (uint8_t)font;
        }
        if (y >= (handle->row - font))
        {
            y = x = 0;
        }
        if (a_st7789_show_char(handle, x, y, *str, font, color) != 0)
        {
            return 1;
        }
        x += (uint8_t)(font / 2);
...
uint8_t st7789_draw_point(st7789_handle_t *handle, uint16_t x, uint16_t y, uint32_t color)
{
    ...
    return a_st7789_draw_point(handle, x, y, color);
}
# 4619 "../driver_st7789.c"
uint8_t st7789_write_cmd(st7789_handle_t *handle, uint8_t cmd)
{
    if (handle == 0)
    {
    ...
    return a_st7789_write_byte(handle, cmd, 0);
}
# 4644 "../driver_st7789.c"
uint8_t st7789_write_data(st7789_handle_t *handle, uint8_t data)
{
    if (handle == 0)
    {
    ...
    return a_st7789_write_byte(handle, data, 1);
}
# 4666 "../driver_st7789.c"
uint8_t st7789_info(st7789_info_t *info)
{
    if (info == 0)
    {
    ...
    memset(info, 0, sizeof(st7789_info_t));
    strncpy(info->chip_name, "Sitronix ST7789", 32);
    strncpy(info->manufacturer_name, "Sitronix", 32);
    strncpy(info->interface, "SPI", 8);
    info->supply_voltage_min_v = 2.4f;
    info->supply_voltage_max_v = 3.3f;
    info->max_current_ma = 7.5f;
    info->temperature_max = 85.0f;
    info->temperature_min = -30.0f;
